...
mod tests {
    ...
    pub fn test_take_instruction() {
        let (mut svm, payer, mint_a, mint_b, escrow, vault, _amount_to_receive, _amount_to_give) =
            setup_make();
        ...
        let taker_ata_b =
            spl_associated_token_account::get_associated_token_address(&taker.pubkey(), &mint_b);
        ...
        let maker_ata_b =
            spl_associated_token_account::get_associated_token_address(&payer.pubkey(), &mint_b);
        ...
        let taker_a_state = spl_token::state::Account::unpack(&taker_a_acc.data).unwrap();
        ...
        let maker_b_state = spl_token::state::Account::unpack(&maker_b_acc.data).unwrap();
    ...
    pub fn test_make_instruction() {
        let (svm, payer, mint_a, _mint_b, escrow, vault, amount_to_receive, amount_to_give) =
            setup_make();
        ...
        let maker_ata_a =
            spl_associated_token_account::get_associated_token_address(&payer.pubkey(), &mint_a);
    ...
    pub fn test_cancel_instruction() {
        let (mut svm, payer, mint_a, _mint_b, escrow, vault, _amount_to_receive, _amount_to_give) =
            setup_make();
    ...
    pub fn test_take_insufficient_balance() {
        ...
        let taker_b_state = spl_token::state::Account::unpack(&taker_b_acc.data).unwrap();
    ...
    pub fn test_cancel_unauthorized() {
        ...
        println!(
            "Vault balance after unauthorized cancel: {}",
            vault_state.amount
        );
